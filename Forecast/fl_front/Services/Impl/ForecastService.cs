...
namespace fl_front.Services.Impl
{
    public class ForecastService : IForecastService
    {
        ...
        public async Task<List<ForecastInsumoSemestreDto>> GetForecastSemestreAsync()
        {
            return await _http.GetFromJsonAsync<List<ForecastInsumoSemestreDto>>("api/forecast/insumos/semestre") ?? new();
        }
    }
}
